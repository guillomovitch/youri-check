...
package Youri::Check::Report::Mail::Format::Text;

=head1 NAME

Youri::Check::Report::Mail::Format::Text - Mail text format support

=head1 DESCRIPTION

This format plugin for L<Youri::Check::Report::Mail> provides text format
support.
