# $Id$
package Youri::Check::Plugin::Report::Mail::Format::HTML;

=head1 NAME

Youri::Check::Plugin::Report::Mail::Format::HTML - HTML format support for mail

=head1 DESCRIPTION

This report format plugin provides HTML format support for mail.
...
use base 'Youri::Check::Plugin::Report::Mail::Format';
