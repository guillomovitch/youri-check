# $Id$
package Youri::Check::Plugin::Report::Mail::Format::Text;

=head1 NAME

Youri::Check::Plugin::Report::Mail::Format::Text - Text format support for mail

=head1 DESCRIPTION

This report format plugin provides text format support for mail.
