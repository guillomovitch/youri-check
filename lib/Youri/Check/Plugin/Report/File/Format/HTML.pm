# $Id$
package Youri::Check::Plugin::Report::File::Format::HTML;

=head1 NAME

Youri::Check::Plugin::Report::File::Format::HTML - HTML format support for files

=head1 DESCRIPTION

This report format plugin provides HTML format support for files.
