package Youri::Check::Plugin::Test::Missing;

=head1 NAME

Youri::Check::Plugin::Test::Missing - Check components consistency
...
Creates and returns a new Youri::Check::Plugin::Test::Missing object.
