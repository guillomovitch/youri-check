# $Id$
package Youri::Check::Plugin::Test::Conflicts;

=head1 NAME

Youri::Check::Plugin::Test::Conflicts - Check file conflicts
...
Creates and returns a new Youri::Check::Plugin::Test::Conflicts object.
            ...
            foreach my $found (@found) {
                ...
                if ($file->is_directory() && $found->[DIRECTORY]) {
                    $result->add_result($self->{_id}, $media, $package, {
                        ...
                        level   => Youri::Check::Plugin::Test::WARNING
...
=head2 compatible($package1, $package2)

Returns true if $package1 is arch-compatible with $package2
...
=head2 conflict($package1, $package2)

Return true if $package1 conflicts with $package2
...
=head2 replace($package1, $package2)

Returns true if $package1 replace $package2
