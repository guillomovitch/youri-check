# $Id$
package Youri::Check::Plugin::Test::Build::Source::Iurt;

=head1 NAME

Youri::Check::Plugin::Test::Build::Source::Iurt - Iurt build log source

=head1 DESCRIPTION

This source plugin for L<Youri::Check::Plugin::Test::Build> collects build logs
...
Creates and returns a new Youri::Check::Plugin::Test::Build::LBD object.
