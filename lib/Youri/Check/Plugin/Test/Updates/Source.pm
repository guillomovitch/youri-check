# $Id$
package Youri::Check::Plugin::Test::Updates::Source;

=head1 NAME

Youri::Check::Plugin::Test::Updates::Source - Abstract updates source

=head1 DESCRIPTION

This abstract class defines the updates source interface for
L<Youri::Check::Plugin::Test::Updates> test plugin.
...
Creates and returns a new Youri::Check::Plugin::Test::Updates object.
