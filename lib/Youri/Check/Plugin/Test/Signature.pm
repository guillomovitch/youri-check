# $Id$
package Youri::Check::Plugin::Test::Signature;

=head1 NAME

Youri::Check::Plugin::Test::Signature - Check signature
...
Creates and returns a new Youri::Check::Plugin::Test::Signature object.
