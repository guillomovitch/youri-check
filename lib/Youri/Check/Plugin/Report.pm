# $Id$
package Youri::Check::Plugin::Report;

=head1 NAME

Youri::Check::Plugin::Report - Abstract output plugin

=head1 DESCRIPTION

This abstract class defines the report plugin interface.
...
Creates and returns a new Youri::Check::Plugin::Report object.
